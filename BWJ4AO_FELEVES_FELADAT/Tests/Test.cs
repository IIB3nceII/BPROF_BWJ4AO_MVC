...
namespace Tests
{
      ...
      public class Test
      {
            ...
            public void BiggestAverageWeightCategory()
            {
                  ...
                  {
                        new Competitor { CompetitorId= Guid.NewGuid().ToString(), Number=1, Name="Kökény Béla", Nationality="Hungary", Gender=GenderType.Male, Height=175, Weight=103,AchivedPlace=12, CategoryId=categlist.ElementAt(0).CategoryId},
            ...
            public void HighestCompetitorCategory()
            {
                  ...
                  List<Competitor> complist = new List<Competitor>()
                  {
                        new Competitor { CompetitorId= Guid.NewGuid().ToString(), Number=1, Name="Kökény Béla", Nationality="Hungary", Gender=GenderType.Male, Height=181, Weight=103,AchivedPlace=12, CategoryId=categlist.ElementAt(0).CategoryId},

                        new Competitor { CompetitorId= Guid.NewGuid().ToString(), Number=2, Name="Kökény Béci", Nationality="Hungary", Gender=GenderType.Male, Height=174, Weight=93,AchivedPlace=11, CategoryId=categlist.ElementAt(1).CategoryId},

                        new Competitor { CompetitorId= Guid.NewGuid().ToString(), Number=3, Name="Kökény Béna", Nationality="Hungary", Gender=GenderType.Male, Height=173, Weight=95,AchivedPlace=8, CategoryId=categlist.ElementAt(2).CategoryId},
                  ...
                  categrepo.Setup(x => x.ListAll()).Returns(categlist.AsQueryable);
                  comprepo.Setup(x => x.ListAll()).Returns(complist.AsQueryable);
                  var result = s.HighestCompCategory(categlist, complist);
                  Assert.That(result, Is.EqualTo(expected));
            }
            ...
            public void CategoryWithHighestNumberOfUSACompetitors()
            {
                  ...
                  List<Competitor> complist = new List<Competitor>()
                  {
                        ...
                        new Competitor { CompetitorId= Guid.NewGuid().ToString(), Number=3, Name="Kökény Béna", Nationality="USA", Gender=GenderType.Male, Height=176, Weight=95,AchivedPlace=8, CategoryId=categlist.ElementAt(2).CategoryId},
